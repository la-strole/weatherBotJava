...
/**
 * The ForecastFull class provides methods to parse and format forecast items
 * into strings for Telegram bot messages.
 * It includes methods to parse individual forecast items and generate formatted
 * forecast strings for specific days.
 * The class also includes a utility method to append formatted forecast item
 * strings to a StringBuilder.
 * 
 * <p>
 * Methods in this class may throw {@link AppErrorCheckedException} if an error
 * occurs during parsing or translation.
 * </p>
 * 
 * <p>
 * Example usage:
 ...
 * 
 * <p>
 * This class is not meant to be instantiated, as it only contains static
 * utility methods.
 * </p>
 * 
 * @see ForecastItem
...
public class ForecastFull {
     ...
     * @throws AppErrorCheckedException If an error occurs during parsing or
     *                                  translation.
     */
     ...
     * @throws AppErrorCheckedException if there is an error during deserialization
     *                                  of forecast items
     */
     ...
     *                           formatted string.
     * @param translateUnit      A flag indicating whether the unit should be
